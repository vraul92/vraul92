...
I build **production-grade AI systems** that solve real-world problems in healthcare, agriculture, and computer vision using foundation models and geometric deep learning.
...
- **AgriTech Foundation Models** - Crop-specific vision transformers
- **Edge AI** - On-device inference for drone applications
- **Mamba & State Space Models** - Efficient sequence modeling
- **3D Gaussian Splatting** - Next-gen neural rendering
...
- 🤝 **Research collaborations** in AgriTech, Healthcare AI, Computer Vision
